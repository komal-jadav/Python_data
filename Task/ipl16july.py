...
import random
#Selection of team------------------------------>
print("-----------Slection of team-------------")
list=["CSK","RCB","MI","RR","KXIP","GT","LSG","DC","SH","KKR"]

select_team=input("Enter team name:")
...
while wickets_1 != 2 and balls_1 != 10:
...
if runs_1 > runs_2:
    ...
    if Bat_first == "You": 
        print("\nCongratulations!",select_team,  "won the Match by",runs_1 - runs_2,"runs.")
    ...
    if Bat_second == "You": 
        print("\nCongratulations!",select_team, "won the Match by",2 - wickets_2,"wickets.")
